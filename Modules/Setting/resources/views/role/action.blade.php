<div class="dropdown">
    ...
    <ul class="dropdown-menu dropdown-menu-end">
        @if (is_null($module->deleted_at))
            <a href="{{ route("role.edit", $module->id) }}" class="dropdown-item"><i
                    class="bx bx-edit"></i> {{ __("buttons.edit") }}</a>
            <a href="#" onclick="confirm('{{ route("role.destroy", $module->id) }}', 1)" class="dropdown-item"><i
                    class="bx bx-trash"></i> {{ __("buttons.delete") }}</a>
        @else
            <a href="#" onclick="confirm('{{ route("role.restore", $module->id) }}', 2)" class="dropdown-item"><i
