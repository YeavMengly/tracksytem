...
@section("content")
    ...
    <div class="row">
        ...
        <div class="col-6">
            <div class="card">
                <div class="card-body">
                    <form class="needs-validation" novalidate method="POST" action="{{ route("notes.store") }}" autocomplete="off">
                        @csrf
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-3">
                                    <label class="form-label" for="vTitle">{{ __("forms.notes.title") }}</label>
                                    <input type="text" class="form-control" id="vTitle" name="txtTitle" required tabindex="1" />
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    <label class="form-label" for="vDescription">{{ __("forms.document.description") }}</label>
